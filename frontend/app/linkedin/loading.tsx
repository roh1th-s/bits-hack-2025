  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md px-4 z-10">
        ...
        <div className="absolute bg-white rounded-xl opacity-90" 
             style={{
               width: "100%",
               height: "120px",
               top: "10px",
          ...
          >
            ...
            >
              ...
              <div 
                ...
                style={{
                  background: 'radial-gradient(circle, rgba(255,255,255,0.3) 0%, rgba(200,200,200,0.1) 70%, rgba(150,150,150,0.2) 100%)',
                  transform: 'scale(0.9)'
                }}
              ></div>
        ...
        <div className="text-center relative z-10">
          <div className="bg-white rounded-lg py-2 px-4 inline-block opacity-90">
